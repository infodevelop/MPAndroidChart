...
public class ScrollPagerActivity extends DemoBase implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            chart.setGestureHelper(new PagerGestureHelper());
        }
