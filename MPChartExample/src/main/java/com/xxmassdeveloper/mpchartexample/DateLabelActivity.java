...
public class DateLabelActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_label);

        setTitle("Date Label Support");
    ...
    private void setData() {
        ...
        if (chart.getData() != null &&
            ...
            set1.setValues(longEntryList.getEntry());
            set1.notifyDataSetChanged();
            chart.getData().notifyDataChanged();
            chart.notifyDataSetChanged();
        } else {
            // create a dataset and give it a type
            set1 = new LineDataSet(longEntryList.getEntry(), "DataSet 1");
        ...
        chart.getXAxis().setValueFormatter(new DateValueFormatter(longEntryList.getReferenceXValue()));
    }

    @Override
    protected void saveToGallery() {
        saveToGallery(chart, "DateLabelActivity");
    }
